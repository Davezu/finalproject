...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Contact JobStreet - Get in touch with our team for job search or hiring assistance" />
        <meta name="author" content="JobStreet" />
        <title>Contact Us - JobStreet</title>
        <!-- Favicon-->
        ...
        <footer class="footer py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto"><div class="small m-0 text-white">Copyright &copy; JobStreet 2023</div></div>
                    <div class="col-auto">
