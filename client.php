...
$jobs = $pdo->query("SELECT * FROM js_tbl")->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="app/view/css/client.css">
    ...
    <div class="main-container">
        <nav class="nav-container">
            <div class="nav-content">
                ...
                <div class="user">
                    <div class="username">
                        <span class="user-link user-profile">Dave Christian</span>
        ...
        <section class="main-content">
            ...
            <?php else: ?>
                <div class="job-card">
                    <h2>Jobstreets</h2>
                    <div class="new-badge">New to you</div>
                    <div class="job-location">Philippines</div>
                    <div class="job-salary">00000</div>
                    <details>
                        <summary>Click for job description</summary>
                        <p>No Data</p>
                    </details>
